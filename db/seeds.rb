...
WebPage.create(pagetitle: 'Home', bartitle: 'Home', body: 'Introduction to lab', ispublic: true)
...
WebPage.create(pagetitle: 'Interest', bartitle: 'Interest', body: 'Information about joining lab', ispublic: true, url: '')
